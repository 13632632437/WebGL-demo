...
function initVertexBuffers(gl) {
    ...
    var verticesColors = new Float32Array([
        // 前
         1.0,  1.0,  1.0, 0.8, 0.6, 0.1,  // v0 0
        -1.0,  1.0,  1.0, 0.8, 0.6, 0.1,  // v1 1
        -1.0, -1.0,  1.0, 0.8, 0.6, 0.1,  // v2 2
         1.0, -1.0,  1.0, 0.8, 0.6, 0.1,  // v3 3 
        // 上
         1.0,  1.0,  1.0, 0.9, 0.2, 0.2,  // v0 4
        -1.0,  1.0,  1.0, 0.9, 0.2, 0.2,  // v1 5
         1.0,  1.0, -1.0, 0.9, 0.2, 0.2,  // v5 6
        -1.0,  1.0, -1.0, 0.9, 0.2, 0.2,  // v6 7
        // 右
         1.0,  1.0,  1.0, 0.5, 0.2, 0.5,  // v0 8
         1.0, -1.0,  1.0, 0.5, 0.2, 0.5,  // v3 9
         1.0, -1.0, -1.0, 0.5, 0.2, 0.5,  // v4 10
         1.0,  1.0, -1.0, 0.5, 0.2, 0.5,  // v5 11
        // 后
         1.0, -1.0, -1.0, 0.4, 0.5, 0.6,  // v4 12
         1.0,  1.0, -1.0, 0.4, 0.5, 0.6,  // v5 13
        -1.0,  1.0, -1.0, 0.4, 0.5, 0.6,  // v6 14
        -1.0, -1.0, -1.0, 0.4, 0.5, 0.6,  // v7 15
        // 下
         1.0, -1.0,  1.0, 0.7, 0.7, 0.7,  // v3 16
         1.0, -1.0, -1.0, 0.7, 0.7, 0.7,  // v4 17
        -1.0, -1.0, -1.0, 0.7, 0.7, 0.7,  // v7 18
        -1.0, -1.0,  1.0, 0.7, 0.7, 0.7,  // v2 19
        // 左
        -1.0,  1.0,  1.0, 0.8, 0.8, 0.9,  // v1 20
        -1.0,  1.0, -1.0, 0.8, 0.8, 0.9,  // v6 21
        -1.0, -1.0, -1.0, 0.8, 0.8, 0.9,  // v7 22
        -1.0, -1.0,  1.0, 0.8, 0.8, 0.9,  // v2 23
    ])
    // 顶点索引（无符号8位整型数）
