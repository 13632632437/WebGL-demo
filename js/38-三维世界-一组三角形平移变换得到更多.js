...
var VSHADER_SOURCE =
    ...
    "uniform mat4 u_ModalMatrix;" + // 模型矩阵：用于平移旋转变换
    "void main() {" +
...
function main() {
    ...
    if (!u_ViewMatrix || !u_ProjMatrix || !u_ModalMatrix) {
        console.log('视图模型矩阵u_ViewMatrix||u_ProjMatrix||u_ModalMatrix变量存储地址获取失败');
        return;
    }
